...
export const WireBatch_Url = API_URL+"cfsb_sqlserver/_table/wirebatchs";  // For Production Env
export const Wires_Url = API_URL+"cfsb_sqlserver/_table/wires?filter=";  // For Production Env
...
export const WireBatch_Url = API_URL+"wirebatchs";  // For Local Env
export const Wires_Url = API_URL+"wires";  // For Local Env
