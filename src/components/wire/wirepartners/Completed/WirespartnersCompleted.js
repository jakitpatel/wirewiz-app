...
import WirespartnersCompletedView from "./WirespartnersCompletedView";
...
const {API_KEY, WireoutPartnersCompleted_Url, API_URL} = window.constVar;

function WirespartnersCompleted(props) {
  ...
  const fetchData = React.useCallback(({ pageSize, pageIndex, filters, sortBy }) => {
    ...
    async function fetchWirePostedRecord() {
      ...
      let url = WireoutPartnersCompleted_Url;
...
export default WirespartnersCompleted;
