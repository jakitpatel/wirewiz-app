...
import WirespartnersPostingView from "./WirespartnersPostingView.js";
...
const {API_KEY, WireoutPartnersPosting_Url, API_URL,env, WirePost2Fiserv_Url} = window.constVar;

function WirespartnersPosting(props) {
  ...
  const fetchData = React.useCallback(({ pageSize, pageIndex, filters, sortBy }) => {
    ...
    async function fetchWirePostedRecord() {
      ...
      let url = WireoutPartnersPosting_Url;
...
export default WirespartnersPosting;
