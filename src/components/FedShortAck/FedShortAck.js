...
import FedShortAckView from "./FedShortAckView.js";
import * as Icon from "react-feather";
import "./FedShortAck.css";
...
const {API_KEY, FedShortAck_Url, env} = window.constVar;

function FedShortAck(props) {
  ...
  const { fedShortAck, pageIndex, pageSize, sortBy, filters, backToList } = useSelector(state => {
    return {
        ...state.fedShortAckReducer
    }
  });
  ...
  const columnDefs = [
    {
      ...
      Cell: obj => {
        ...
        return (
          <Link
            to={{
              pathname: `${process.env.PUBLIC_URL}/fedShortAckDetails/${wireListObj.fedShortAckID}`,
  ...
  let headerTitle = "FedShortAck List";

  console.log("FedShortAck", fedShortAck);
