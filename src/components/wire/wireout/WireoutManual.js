...
const {API_KEY, WireoutManual_Url, env} = window.constVar;

function WireoutManual(props) {
  ...
  useEffect(() => {
    ...
    async function fetchWireInRecord() {
      ...
      let url = WireoutManual_Url;
      if(env==="DEVLOCAL"){
        url = WireoutManual_Url;
      }
      ...
      <div className="container" style={{marginLeft:"0px", width:"100%", maxWidth:"100%"}}>
        <div className="row">
          <div className="col-sm-12 col-md-offset-3">
            <div>
              <h3 style={{float:"left"}} className="title-center">Outbound Wires - Manual Processing</h3>
