...
export const WireDetails_Url = API_URL+"cfsb_sqlserver/_table/getWireDetails?filter=";  // For Production Env
...
export const WireDocList_Url = API_URL+"cfsb_sqlserver/_table/wireDoc?filter=";  // For Production Env
...
export const WireDetails_Url = API_URL+"getWireDetails";  // For Local Env
...
export const WireDocList_Url = API_URL+"wireDoc";  // For Local Env
*/